...
| 型号 | 平台 | 短信转发 | 来电提醒 | 说明 |
|---|---|---|---|---|
| **Air780EHV** | EC718 | 全网通 | ✅ | **已验证**——本固件的开发与测试基准 |
| Air780EHM / Air780EGH | EC718 | 全网通 | ✅ | 与 EHV 同平台，官方 demo 同项目分发；EGH 额外带 GNSS |
| Air780EPV 系列（EPV/EPVH/EPVZ 等） | EC718P-V | 全网通 | ✅ | 带 Audio Codec 的 EP 变体（VoLTE） |
| Air780EP / EPG / EPZ | EC718P | 移动/联通 | ❌ | 无音频：电信卡短信与来电提醒均不可用，其余功能不受影响 |
| Air780EPM / Air780EPS | EC718 | 移动/联通 | ❌ | 低功耗版（EPM 仅支持 LuatOS 开发）；无内置音频，来电提醒预期不可用 |
| Air780E / Air780EG | EC618 | 移动/联通 | ❌ | [官方 wiki 明确](https://wiki.luatos.org/chips/air780e/mcu.html)：不支持电信网络短信、不支持 VoLTE |
